/**
 * SVG Icons library for Web Scraper UI.
 * Pure Vanilla JavaScript with inline SVG helpers.
 */
(function (root, factory) {
  ...
  if (root) root.AppIcons = result;
  if (typeof window !== 'undefined') window.AppIcons = result;
  if (typeof globalThis !== 'undefined') globalThis.AppIcons = result;
}(typeof self !== 'undefined' ? self : this, function () {
  'use strict';

  const icons = {
    spider: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m8 6 4-4 4 4"/><path d="M12 2v10.3"/><path d="m19 11 3-3"/><path d="m22 19-5-5"/><path d="m2 19 5-5"/><path d="m5 8-3 3"/><path d="M4 14h16"/><path d="M9 18a3 3 0 0 0 6 0"/></svg>',
    ...
    eye: '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>',
  ...
  function get(name, customClass) {
    const svg = icons[name] || icons.spider;
    if (customClass) {
